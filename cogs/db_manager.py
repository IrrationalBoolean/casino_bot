...
async def get_balance(bot, member):
    cursor = await bot.db.execute(
        "SELECT balance, total_earnings, total_losses  FROM user WHERE guild_id = ? and user_id =?",
        (member.guild.id, member.author.id))
